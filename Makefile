...
# Source files
SVMIX_SRCS := $(SRC_DIR)/util.c $(SRC_DIR)/model_sv.c
...
# Targets
.PHONY: all clean test test-unit test-integration test-student-t test-model-sv test-smoke test-determinism fastpf

all: $(BIN_DIR)/test_student_t $(BIN_DIR)/test_model_sv $(BIN_DIR)/test_sv_fastpf_smoke $(BIN_DIR)/test_sv_fastpf_determinism
...
test-unit: test-student-t test-model-sv
